...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.save_every is not None and epoch > 0 and epoch % args.save_every == 0:
            # if save_every is defined we checkpoint
            save_checkpoint(
                {
                    "epoch": epoch + 1,
                    "state_dict": model.state_dict(),
    ...
    save_checkpoint(
        ...
        is_best,
        filename=os.path.join(args.save_dir, "checkpoint_final.th"),
    )
