...
save_dir = "/home/jonna/hyperparameters-under-pruning/experiments2.0/cifar10/mobilenetv2/finetuning/magnitude_40/results"
...
for root, dirs, files in os.walk(
    ...
    for file in files:
        if file.endswith("checkpoint_final.th"):
            ...
            if Path(f"{savedir}/mobilenetv2_magnitude_40.th").is_file():
                break
            ...
            pruning_method = PruningMethod(
                scorer, [tactic], target=Target(Flops(), fraction=0.4)
            )
            ...
            torch.save(
                model,
                f"{savedir}/mobilenetv2_magnitude_40.th",
            )