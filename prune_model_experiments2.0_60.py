...
save_dir = "/home/jonna/hyperparameters-under-pruning/experiments2.0/cifar10/resnet56/finetuning/magnitude_60/results"
...
for root, dirs, files in os.walk(
    ...
    for file in files:
        if file.endswith("checkpoint_final.th"):
            ...
            if Path(f"{savedir}/resnet56_magnitude_60.th").is_file():
                break
            ...
            torch.save(
                model,
                f"{savedir}/resnet56_magnitude_60.th",
            )